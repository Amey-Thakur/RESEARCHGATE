...
To document a security concern, communication is facilitated with the project curators:
  ...
  - **Method**: Reports are submitted via the repository's [GitHub Issues](https://github.com/Amey-Thakur/RESEARCHGATE/issues) interface to formally record security-related findings.
...
## Implementation Context: ResearchGate Scholarly Publications

This project consists of a curated collection of **scholarly articles**, **presentations**, **technical reports**, and **project implementations**, designed for academic archival and reference purposes in the fields of Computer Science and Engineering.

-   **Scope Limitation**: This policy applies exclusively to the documentation, code, and asset resources contained within this repository and does not extend to the runtime environment or third-party dependencies associated with the project implementations.
...
*This document defines the security posture of a finalized ResearchGate Scholarly Publications project.*
